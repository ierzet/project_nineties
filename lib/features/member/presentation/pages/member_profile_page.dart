...
class MemberProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final member = context.read<MemberValidatorBloc>().state.data;
                  ...
                  children: [
                    ...
                    Center(
                      child: CircleAvatar(
                        ...
                        backgroundImage: member.memberPhotoOfVehicle != null &&
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      member.memberPhoneNumber ?? 'No Phone',
                                      style: const TextStyle(
                                        fontSize: 16,
                                      ),
                                    ),
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      member.memberYearOfVehicle.toString(),
                                    ),
                                  ],
                                ),
                                const SizedBox(height: 8),
                                ...
                                Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Text(
                                      member.memberTypeOfVehicle ?? 'No Data',
                                    ),
                                  ],
                                ),
                                const SizedBox(height: 8),
                                Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Text(
                                      member.memberBrandOfVehicle ?? 'No Data',
                                    ),
                                  ],
                                ),
                                const SizedBox(height: 8),
                                Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Text(
                                      member.memberSizeOfVehicle ?? 'No Data',
                                    ),
                                  ],
                                ),
                                const SizedBox(height: 8),
                                Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Text(
                                      member.memberColorOfVehicle ?? 'No Data',
                                    ),
                                  ],
                                ),
                              ],
                          ...
                          Padding(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final history =
                                    member.membershipHistory![reversedIndex];
